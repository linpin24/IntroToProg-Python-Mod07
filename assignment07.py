...
#   Leena Chaudhuri,29/05/2024,Changed Script
# ------------------------------------------------------------------------------------------ #
import json
...
Leena Chaudhuri,29/05/2024,Created Class
"""
...
class Student(Person):
    ...
    def course_name(self, value:str):
        ...
        '''
            ...
            raise ValueError ("Enter Value, don't leave empty")
            '''
        # WAS TRYING ERROR HANDLING FOR NO VALUE, COULDN'T GET THAT TO WORK
...
class FileProcessor:
    ...
    def write_data_to_file(file_name: str, student_data: list):
        ...
        ChangeLog: (Who, When, What)
        RRoot,1.1.2030,Created function
        Leena Chaudhuri,29/05/2024,Altered function to create object and add context manager
...
class IO:
    ...
    def output_student_and_course_names(student_data: list):
        ...
        ChangeLog: (Who, When, What)
        RRoot,1.1.2030,Created function
        Leena Chaudhuri,29/05/2024,Converted dict to objects
    ...
    def input_student_data(student_data: list):
        ...
        ChangeLog: (Who, When, What)
        RRoot,1.1.2030,Created function
        Leena Chaudhuri,29/05/2024,altered function
...
""" 
        ...
        ChangeLog: (Who, When, What)
        Leena Chaudhuri,29/05/2024,added main
        """
# Start of main body
